...
<table width="520" cellpadding="0" cellspacing="0" style="background:#161B24;border-radius:12px;border:1px solid rgba(255,255,255,.07);">
  ...
  <tr><td style="padding:24px 32px;">
    <h2 style="color:#E8EDF5;font-size:18px;margin:0 0 16px;">Mot de passe r&eacute;initialis&eacute;</h2>
    <p style="color:#8A97AC;font-size:14px;line-height:1.6;margin:0 0 20px;">
      Bonjour <strong style="color:#E8EDF5;">{{ $nom }}</strong>,<br>
      Votre mot de passe a &eacute;t&eacute; r&eacute;initialis&eacute; par un administrateur.
    </p>
    <div style="background:#1E2530;border-radius:8px;padding:18px 20px;margin:0 0 20px;">
      ...
      <div style="font-size:11px;color:#5A6578;text-transform:uppercase;letter-spacing:.08em;">Nouveau mot de passe</div>
      <div style="font-family:'Courier New',monospace;font-size:18px;color:#2ECC7A;font-weight:700;margin:4px 0;letter-spacing:.1em;">{{ $password }}</div>
    </div>
    ...
    <div style="background:rgba(240,160,48,.1);border-radius:6px;padding:12px 16px;font-size:12px;color:#F0A030;">
      &#9888; Changez ce mot de passe d&egrave;s votre prochaine connexion.
    </div>
  </td></tr>
